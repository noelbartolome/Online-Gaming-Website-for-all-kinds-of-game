 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-9">
                    <div class="box">
                        ...
                        <p class="text-muted">To keep your account secured we advice you to change your password every hour.</p>

                        <h3>Change password</h3>

                        <form action="changePass_func.php" method="post" id="form3">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="password_old">Old password</label>
                                        <input name="oldpw" type="password" class="form-control" id="password_old">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input name="newpw" type="password" class="form-control" id="password_1">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div class="col-sm-12 text-center">
                                <button type="submit" form="form3" value="submit" class="btn btn-primary"><i class="fa fa-save"></i> Save new password</button>
                            </div>
                        </form>
