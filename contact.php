                    ...
                    <div class="box" id="contact">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <p class="text-muted">This number is blah blah blah blah business otherwise we advise you to use the electronic form of communication.</p>
                                <p><strong>+639 6969 666</strong>
                                </p>
                            </div>
                            <!-- /.col-sm-4 -->
                            <div class="col-sm-4">
                                ...
                                <ul>
                                    <li><strong><a href="mailto:">emailkunware@email.com</a></strong>
                                    </li>
                                </ul>
                            </div>
                            <!-- /.col-sm-4 -->
