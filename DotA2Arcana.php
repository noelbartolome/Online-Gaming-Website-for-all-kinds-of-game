                ...
                <div class="col-md-12">
                    ...
                    <div class="row products">
                            <?php
                                ...
                                $query = "SELECT * FROM `product` WHERE `type`= 'arcana'";
                                $result = mysql_query($query);
                                               ...
                                               <div class='col-md-3 col-sm-4'>
                                                    <div class='product'>
                                                        <div class='text'>
                                                             ...
                                                             <p class='buttons'>
                                                                <a href='addProductToCart_func.php?product_id=$row[product_id]&url=dota2arcana' class='btn btn-primary'><i class='fa fa-shopping-cart'></i>Add to cart</a>
                                                             </p>
