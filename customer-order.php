...
<body>
 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-9" id="customer-order">
                    <div class="box">
                        <p class="lead">Your order was being processed and is currently being prepared.</p>
                        <p>We will notify you through text and email if your order was on its way.</p>
                            ...
                            <table class="table">
                                <thead>
                                        ...
                                        <tbody>
                                            ...
                                            while($row = mysql_fetch_assoc($result)){
                                                ...
                                                echo"
                                                    <tr>
                                                        <td colspan='3'>$row_product[name]</td>
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <th><strong><?php subtotal("total")?></strong></th>
                                    </tr>
                                </tfoot>
                            </table>
                        ...
                        <div class="row addresses">
                            <div class="col-md-6">
                                ...
                                <?php
                                echo"
                                    <p>$_SESSION[fname] $_SESSION[lname]
                                        <br>$_SESSION[mobile_num]
                                        <br>$_SESSION[email]
                                        <br>$_SESSION[address]
                                ";
                                ?>
                            ...
                            <div class="col-md-6">
                                <a href="shopAgain_func.php" class='btn btn-primary'><i class='fa fa-shopping-cart'></i>Shop Again</a>
                            </div>
                        </div>
