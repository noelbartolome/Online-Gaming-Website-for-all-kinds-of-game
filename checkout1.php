        ...
        <div id="content">
            <div class="container">
                ...
                <div class="col-md-9" id="checkout">
                    ...
                    <div class="box">
                        <form method="post" action="deliveryForm_func.php" id="form2">
                            <h1>Checkout</h1>
                        ...
                        function clearDefault(a){if(a.defaultValue==a.value){a.value=""}};
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input  onFocus="clearDefault(this)" name="fname" type="text" class="form-control" id="firstname" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="lastname">Lastname</label>
                                            <input  onFocus="clearDefault(this)" name="lname" type="text" class="form-control" id="lastname" required>
                                        </div>
                                    </div>
                                </div>
                                <!-- /.row -->
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input  onFocus="clearDefault(this)" name="address" type="text" class="form-control" id="address" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-3">
                                        <div class="form-group">
                                            <label for="city">Mobile #</label>
                                            <input  onFocus="clearDefault(this)" name="mobile_num" type="text" class="form-control" id="mobile_id" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-3">
                                        <div class="form-group">
                                            <label for="city">Email</label>
                                            <input  onFocus="clearDefault(this)" name="email" type="text" class="form-control" id="email" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box-footer">
                                ...
                                <div class="pull-right">
                                    <button type="submit" form="form2" class="btn btn-primary">Continue to Order Review<i class="fa fa-chevron-right"></i>
                                    </button>
                                </div>
                            </div>
                        </form>
